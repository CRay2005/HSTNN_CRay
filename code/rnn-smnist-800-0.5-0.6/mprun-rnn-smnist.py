...
#ratio_list = [0.5050]
#ratio_list = [0.4510]    # rnn0.45 snn1.0，与0.55对比，分析snn如何剪枝
#ratio_list = [0.2525]
#ratio_list = [0.2550]
#ratio_list = [0.5025]
#ratio_list = [0.10025]  # rnn 1，snn 0.25
ratio_list = [0.0505]  # 
...
SMNIST_FFS_Parameter["mode"]         = "test1"    # "train1" for train and "test1" for test
...
SMNIST_HBR_Parameter["mode"]         = "train2"    # "train2" for train and "test2" for test
